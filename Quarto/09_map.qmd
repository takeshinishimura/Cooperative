...
ggsave(file = "number_of_ja_by_pref_lollipop.pdf", plot = p, path = outdir, width = 10, height = 7)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_lollipop_ordered.pdf", plot = p, path = outdir, width = 10, height = 7)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_map_by_pref.pdf", plot = p, path = outdir, width = 8, height = 7)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_map_by_pref_bertin.pdf", plot = p, path = outdir, width = 8, height = 7)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_map2.pdf", plot = p, path = outdir, width = 10, height = 10)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_senmon_ippannoukyou.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_senmon_chikusan.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_senmon_rakunou.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_senmon_youkei.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_senmon_makinokanri.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_senmon_engeitokusan.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_senmon_nousonkougyou.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_senmon_noujihousou.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
```{r}
#| include: false
ggsave(file = "number_of_ja_by_pref_senmon_sonota.pdf", plot = p, path = outdir, width = 8, height = 4)
```
