...
ggsave(file = "ja_members_1993-2022.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
#| include: false
#| warning: false
ggsave(file = "ja_members_sei_vs_jun_1993-2022.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
#| include: false
#| warning: false
ggsave(file = "ja_members_sei_vs_jun_by_pref.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
#| include: false
#| warning: false
ggsave(file = "ja_members_sei_vs_jun_Ehime.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
#| include: false
#| warning: false
ggsave(file = "ja_members_sei_vs_jun_Hokkaido.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
#| include: false
#| warning: false
ggsave(file = "ja_members_sei_vs_jun_Aichi.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
#| include: false
#| warning: false
ggsave(file = "ja_members_sei_vs_jun_Kyoto.pdf", plot = p, path = outdir, width = 8, height = 4)
```
...
#| include: false
#| warning: false
ggsave(file = "ja_members_sei_vs_jun_Tokushima.pdf", plot = p, path = outdir, width = 8, height = 4)
```
