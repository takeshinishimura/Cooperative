...
これらの絵画を見たければ，Google検索すると多くの画像が表示される。
...
そして，CC BY-NC-SA 4.0ライセンスの下，大英博物館の次のページで公開されていることまでたどり着ける。
...
このモデルは精度が高いことが分かる。
ここでは，[ternaus/retinaface](https://github.com/ternaus/retinaface){target="_blank"} を使って顔認識している。
